...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    Handler getHnadler = new Handler();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.feed_set06).setOnClickListener(this);
        findViewById(R.id.feed_prg01).setOnClickListener(this);
        findViewById(R.id.feed_prg02).setOnClickListener(this);
        findViewById(R.id.feed_prg03).setOnClickListener(this);
        findViewById(R.id.feed_prg04).setOnClickListener(this);
        findViewById(R.id.feed_prg05).setOnClickListener(this);
        findViewById(R.id.feed_prg06).setOnClickListener(this);
        findViewById(R.id.fpick_up_end).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.server_create_button: {
                serverIpText.setText(getLocalIpAddress() + ":8080");
                serverCreate();
            }
            break;
            ...
            break;
            case R.id.feed_set06: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.feed_prg01: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.feed_prg02: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.feed_prg03: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.feed_prg04: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.feed_prg05: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.feed_prg06: {
                sendMessage((((Button) v).getText().toString()));
            }
            break;
            case R.id.fpick_up_end: {
                sendMessage((((Button) v).getText().toString()));
//                joinServer();
            }
            break;
